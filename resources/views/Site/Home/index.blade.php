...
<html class="wide" lang="en">
  <head>
    ...
    <script src={{asset("Site/cdn-cgi/apps/head/3ts2ksMwXvKRuG480KNifJ2_JNM.js")}}></script><link rel="icon" href={{asset("Site/images/favicon.ico")}} type="image/x-icon">
    <link rel="stylesheet" type="text/css" href={{asset("Site/fonts/fontawesome-webfont.woff")}}>
    <link rel="stylesheet" href={{asset("Site/css/bootstrap.css")}}>
    <link rel="stylesheet" href={{asset("Site/css/fonts.css")}}>
    <link rel="stylesheet" href={{asset("Site/css/style.css")}}>
    <link rel="stylesheet" href={{asset("Site/css/css.css")}}>
    <style>.ie-panel{display: none;background: #212121;padding: 10px 0;box-shadow: 3px 3px 5px 0 rgba(0,0,0,.3);clear: both;text-align:center;position: relative;z-index: 1;} html.ie-10 .ie-panel, html.lt-ie-10 .ie-panel {display: block;}</style>
  </head>
  <body>
    <div class="ie-panel"> <a href="https://windows.microsoft.com/en-US/internet-explorer/"><img src={{asset("Site/images/ie8-panel/warning_bar_0000_us.jpg")}} height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today."></a></div>
    <div class="preloader">
    ...
    <div class="page">
      ...
      <header class="section page-header jumbotron-creative">
              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="rd-navbar-brand">
                    <!--Brand--><a class="brand" href="index.blade.php"><img class="brand-logo-dark" src={{asset("Site/images/logo-default-286x52.png")}} alt="" width="143" height="26"/><img class="brand-logo-light" src="images/logo-inverse-286x52.png" alt="" width="143" height="26"/></a>
                  </div>
                </div>
        ...
        <div class="jumbotron-creative-inner">
          ...
          <div class="jc-decoration">
            ...
            </div><img class="jc-decoration-image" src={{asset("Site/images/home-1-748x528.png")}} alt="" width="748" height="528"/>
          </div>
        </div>
      </header>
                ...
                <table class="table-job-offers table-responsive">
                  <tr>
                    ...
                    <td class="table-job-offers-main">
                      ...
                      <article class="company-light">
                        <figure class="company-light-figure"><img class="company-light-image" src={{asset("Site/images/company-1-45x45.png")}} alt="" width="45" height="45"/>
                        </figure>
                  ...
                  <tr>
                    ...
                    <td class="table-job-offers-main">
                      <!-- Company Light-->
                      <article class="company-light">
                        <figure class="company-light-figure"><img class="company-light-image" src={{asset("Site/images/company-2-38x49.png")}} alt="" width="38" height="49"/>
                        </figure>
                        <div class="company-light-main">
                  ...
                  <tr>
                    ...
                    <td class="table-job-offers-main">
                      <!-- Company Light-->
                      <article class="company-light">
                        <figure class="company-light-figure"><img class="company-light-image" src={{asset("Site/images/company-3-46x52.png")}} alt="" width="46" height="52"/>
                        </figure>
                        <div class="company-light-main">
                  ...
                  <tr>
                    ...
                    <td class="table-job-offers-main">
                      <!-- Company Light-->
                      <article class="company-light">
                        <figure class="company-light-figure"><img class="company-light-image" src={{asset("Site/images/company-4-50x49.png")}} alt="" width="50" height="49"/>
                        </figure>
                        <div class="company-light-main">
                  ...
                  <tr>
                    ...
                    <td class="table-job-offers-main">
                      <!-- Company Light-->
                      <article class="company-light">
                        <figure class="company-light-figure"><img class="company-light-image" src={{"Site/images/company-5-48x44.png"}} alt="" width="48" height="44"/>
                        </figure>
                        <div class="company-light-main">
        ...
        <div class="container">
          ...
          <div class="owl-carousel owl-carousel-profile" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="4" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="false" data-fade="true" data-margin="30" data-mouse-drag="false">
            <!-- Profile Classic--><a class="profile-classic" href="resume-page.html">
              <figure class="profile-classic-figure"><img class="profile-classic-image" src={{asset("Site/images/candidates-grid-1-266x219.jpg")}} alt="" width="266" height="219"/>
              </figure>
            ...
            <!-- Profile Classic--><a class="profile-classic" href="resume-page.html">
              <figure class="profile-classic-figure"><img class="profile-classic-image" src={{asset("Site/images/candidates-grid-2-266x219.jpg")}} alt="" width="266" height="219"/>
              </figure>
              <div class="profile-classic-main">
            ...
            <!-- Profile Classic--><a class="profile-classic" href="resume-page.html">
              <figure class="profile-classic-figure"><img class="profile-classic-image" src={{asset("Site/images/candidates-grid-3-266x219.jpg")}} alt="" width="266" height="219"/>
              </figure>
              <div class="profile-classic-main">
            ...
            <!-- Profile Classic--><a class="profile-classic" href="resume-page.html">
              <figure class="profile-classic-figure"><img class="profile-classic-image" src={{asset("Site/images/candidates-grid-4-266x219.jpg")}} alt="" width="266" height="219"/>
              </figure>
              <div class="profile-classic-main">
          ...
          <div class="container">
            ...
            <div class="owl-carousel" data-items="1" data-md-items="2" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="false" data-margin="30" data-autoplay="true" data-mouse-drag="false">
              <blockquote class="quote-mary">
                ...
                <div class="quote-mary-meta"><img class="quote-mary-avatar" src={{asset("Site/images/user-2-73x73.jpg")}} alt="" width="73" height="73"/>
              ...
              <blockquote class="quote-mary">
                ...
                <div class="quote-mary-meta"><img class="quote-mary-avatar" src={{asset("Site/images/user-1-73x73.jpg")}} alt="" width="73" height="73"/>
                  <div class="quote-mary-info">
              ...
              <blockquote class="quote-mary">
                ...
                <div class="quote-mary-meta"><img class="quote-mary-avatar" src={{asset("Site/images/user-4-73x73.jpg")}} alt="" width="73" height="73"/>
                  <div class="quote-mary-info">
        ...
        <div class="container">
          ...
          <div class="row row-30 row-xl-70">
            <div class="col-12 col-lg-4">
              <!-- Post Minimal-->
              <article class="post-minimal"><a class="post-minimal-media" href="blog-post.html"><img class="post-minimal-image" src={{asset("Site/images/blog-1-369x253.jpg")}} alt="" width="369" height="253"/></a>
            ...
            <div class="col-12 col-lg-4">
              <!-- Post Minimal-->
              <article class="post-minimal"><a class="post-minimal-media" href="blog-post.html"><img class="post-minimal-image" src={{asset("Site/images/blog-2-369x253.jpg")}} alt="" width="369" height="253"/></a>
                <div class="post-minimal-main">
            ...
            <div class="col-12 col-lg-4">
              <!-- Post Minimal-->
              <article class="post-minimal"><a class="post-minimal-media" href="blog-post.html"><img class="post-minimal-image" src={{asset("Site/images/blog-3-369x253.jpg")}} alt="" width="369" height="253"/></a>
                <div class="post-minimal-main">
      ...
      <section class="section section-md bg-default text-center">
        <div class="container">
          ...
          <div class="group"><a class="button button-primary button-fixed-size" href="#"><img src={{asset("Site/images/google-play-download-138x35.png")}} alt="" width="138" height="35"/></a><a class="button button-primary button-fixed-size" href="#"><img src="images/appstore.svg" alt=""></a></div>
        </div>
      </section>
      <!-- Page Footer-->
