                        ...
                        <form action="{{route('admin.categories.store')}}" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cat_name"
                                               placeholder="محل قرارگیری تیتر را وارد کنید ..." value="{{old('cat_name')}}">
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <lable> توضیحات</lable>
                                        <textarea rows="5" type="text" class="form-control" name="cat_desc" id="description" placeholder="توضیحات  وارد کنید ..." value="{{old('cat_desc')}}"></textarea>
                                    </div>
                                </div>
