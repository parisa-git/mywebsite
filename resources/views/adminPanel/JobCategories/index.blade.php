                ...
                <div class="row mb-2">
                    <div class="col-sm-9 d-flex">
                        ...
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">جداول دسته بندی
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card-header d-flex">
                            ...
                            <button type="button" id="add_btn" data-toggle="modal" data-target="#addModal"
                                    class="btn btn-outline-dark btn-lg px-3"><a class="nav-link text-dark"
                                                                                href={{route('admin.categories.create')}}>افزودن<i
                                        class="m-1 fa fa-plus"></i>
                                </a>

                            </button>
                            <h3 class="card-title text-right pt-3" style="position: relative; left: 500px">جدول دسته
                                بندی مشاغل</h3>
                        </div>
                        <!-- /.card-header -->
                            ...
                            <table id="example2" class="table table-bordered table-hover mb-4">
                                ...
                                @foreach($JobCategories as $item)
                                    <tr>
                                        ...
                                        <td><img width="100px" src="{{ url('') }}{{$item->cat_icon}}"
                                                 alt="{{$item->cat_name}}"></td>

                                        <td>{!! Illuminate\Support\Str::limit($item->cat_desc, 10) !!}</td>
                                        <td>
