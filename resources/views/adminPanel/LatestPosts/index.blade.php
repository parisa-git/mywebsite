                        ...
                        <div class="card-header d-flex">
                            ...
                            <button type="button" id="add_btn" data-toggle="modal" data-target="#addModal"
                                    class="btn btn-outline-dark btn-lg px-3"><a class="nav-link text-dark"
                                                                                href={{route('admin.posts.create')}}>افزودن<i
                                        class="m-1 fa fa-plus"></i>
                                </a>

                            </button>
                            <h3 class="card-title text-right pt-3" style="position: relative; left: 500px">
                                @yield('pageTitle')</h3>
                        </div>
                        <!-- /.card-header -->
                            ...
                            <table id="example2" class="table table-bordered table-hover mb-4">
                                ...
                                @foreach($LatestPosts as $item)
                                    <tr>
                                        ...
                                        <td><img width="100px" src="{{ url('') }}{{$item->image}}"
                                                 alt="{{$item->image}}"></td>

                                        <td>{!! Illuminate\Support\Str::limit($item->text, 10) !!}</td>
                                        <td>
                                            <a class="btn btn-outline-primary m-1 ajax  "
                                               href="{{route('admin.posts.edit', $item->id)}}"
