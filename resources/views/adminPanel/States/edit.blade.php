                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.state.index')}}">استان</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="card text-right col-12" >
                    ...
                    {{--    <-----------card body ------->--}}
                    <div class="card-body">
                        <form action="{{route('admin.state.update' , $States->id )}}" role="form" method="post">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name"
                                               placeholder="تیتر اول را وارد کنید ..." value="{{$States->name}}">
                                    </div>
                                </div>
