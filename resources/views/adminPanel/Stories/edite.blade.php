                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.stories.index')}}">داستان ها</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="card text-right" >
                    ...
                    {{--    <-----------card body ------->--}}
                    <div class="card-body">
                        <form action="{{route('admin.stories.update' , $Stories->id )}}" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " name="story_fullName"
                                               placeholder="نام شرکت را وارد کنید ..." value="{{$Stories->story_fullName}}">
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="story_jobTitle"
                                               placeholder="توضیحات مختصر را وارد کنید ..." value="{{$Stories->story_jobTitle}}">
                                    </div>
                                </div>
                                <!-----------companies_image---------->
                                @if($Stories->story_image != null && $Stories->story_image !='')
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label>عکس </label>
                                            <div class="input-group">
                                                <div class="custom-file" >
                                                    <input type="file" class="custom-file-input" name="story_image">
                                                    <img name="thumbnail" style="width: 50%; margin-top: 220px" src="{{ url('') }}{{ $Stories->story_image }}">
                                ...
                                <div class="col-sm-12" style="margin-top: 200px">
                                    <div class="form-group">
                                        <lable>توضیحات </lable>
                                        <textarea rows="5" type="text" class="form-control" name="story_text" id="description" placeholder="توضیحات  را وارد کنید ..." value="{{$Stories->story_text}}">{!!$Stories->story_text !!}</textarea>
                                    </div>
                                </div>
