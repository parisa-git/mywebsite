                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="titleLocation"
                                               placeholder="محل قرارگیری تیتر را وارد کنید ..." value="{{old('titleLocation')}}">
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="firstTitle"
                                               placeholder="تیتر اول را وارد کنید ..." value="{{old('firstTitle')}}">
                                    </div>
                                </div>
                                <!-----------title second---------->
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="secendTitle"
                                               placeholder="تیتر دوم را وارد کنید ..." value="{{old('secendTitle')}}">
                                    </div>
                                </div>
                                <!-----------title description---------->
                                <div class="col-sm-12">
