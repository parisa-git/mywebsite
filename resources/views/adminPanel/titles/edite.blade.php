                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" type="text" class="form-control" name="description" id="description" placeholder="توضیحات زیر تیتر را وارد کنید ..." value="{{$title->description}}"></textarea>
                                    </div>
                                </div>
