                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="firstTitle" disabled
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="secendTitle" disabled
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" type="text" class="form-control" name="description" id="description"
                                                  disabled     placeholder="توضیحات زیر تیتر را وارد کنید ..." value="{{$title->description}}">{!!$title->description !!}</textarea>
                                    </div>
                                </div>
